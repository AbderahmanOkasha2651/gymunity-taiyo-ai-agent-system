...
![Azure AI Foundry Agents List](agents-list.png)
...
- Coach visibility permission test
- Safety red flag test
- Admin Ops payment risk test

Screenshots should not include API keys, access tokens, secrets, private user data, or real payment credentials.
